...
namespace HzNS.Cmdr.Tool.ObjectCloner.Internal
{
    ...
    internal static class TypeHelper
    {
        ...
        private static readonly ConcurrentDictionary<Type, bool> _canSkipDeepCloneMap =
        ...
        {
            return _canSkipDeepCloneMap.GetOrAdd(type,
                t => t.IsPrimitive || t == typeof(string) || t == typeof(object));
        }
        ...
        public static IEnumerable<FieldInfo> GetAllFieldsDeep(this Type type)
        {
            ...
            IEnumerable<FieldInfo> ownFields =
